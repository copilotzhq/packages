...
export const defaultChatConfig: Required<ChatConfig> = {
  ...
  labels: {
    ...
    deleteConfirmDescription:
      "Are you sure you want to delete this conversation? This action cannot be undone. All messages will be permanently lost.",
    renameThread: "Rename",
...
export function mergeConfig(
  ...
  return {
    ...
    customComponent:
      userConfig.customComponent || defaultChatConfig.customComponent,
    headerActions: userConfig.headerActions || defaultChatConfig.headerActions,
    headerMenuItems:
      userConfig.headerMenuItems || defaultChatConfig.headerMenuItems,
  };
}
